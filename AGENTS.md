...
- Keep the customer post-query result decision-first and calm: lead with the verdict, one dominant protective action, and no more than three plain-language signals. Keep confidence percentages, campaign metrics, full evidence, and source history out of the primary view and place supporting analysis behind an optional disclosure; anonymous reporting must remain directly accessible.
